...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="h-full flex flex-col bg-purple-50/30 relative">
      ...
      <link rel="preload" as="image" href="/splite/luna_sprite_1.png" fetchPriority="high" />
      <link rel="preload" as="image" href="/splite/luna_sprite_setting_1.png" fetchPriority="high" />
