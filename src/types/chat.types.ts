...
export interface StreamEvent {
  type: 'text' | 'state' | 'nudge' | 'done' | 'error' | 'suggestions' | 'panel' | 'strategy' | 'axes_progress' | 'axis_choices' | 'phase_event' | 'phase_change' | 'hlre_replace' | 'context_log' | 'luna_thinking_deep' | 'intimacy_level_up' | 'retry_status' | 'fx' | 'mode_complete';
