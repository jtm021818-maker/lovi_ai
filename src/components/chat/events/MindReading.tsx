...
/**
 * 🆕 GTC 모델: 마음 헤아리기 (Mentalizing) 이벤트
 *
 * Mind Reading(단정) → Mentalizing(탐색)으로 전환.
 * "정답 맞추기"가 아니라 "함께 찾아가는 탐색 여정".
 *
 * 3선택지: 맞아 / 좀 다른데 / 잘 모르겠어
 * 가설형 문장: "~거 아니야?" → "혹시... ~느낌도 있어?"
 * 허락 질문: "야 나 느낌 오는 게 있는데, 말해도 돼?"
 */
          ...
          {phase === 'different' && (
            ...
            >
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 mb-4 border border-violet-100/50">
                ...
                <div className="text-[11px] text-gray-400 mb-3">그럼 지금 어떤 느낌인지 알려줘 — 한 줄이면 돼!</div>
                <textarea
                  value={userInput}
