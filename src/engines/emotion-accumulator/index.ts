...
// 🆕 v74: isReadyForMirror 함수 완전 제거.
//   VN 극장 트리거 = 좌뇌 LLM 의 event_recommendation 또는 우뇌 [MIND_READ_READY] 태그.
//   재료 충분 여부 = mirror-generator 의 LLM 이 ready=true/false 로 자체 판단.
//   코드 게이트 없음. 판단은 LLM 만.
